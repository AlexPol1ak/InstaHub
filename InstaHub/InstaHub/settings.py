"""
Django settings for InstaHub project.
...
WSGI_APPLICATION = 'InstaHub.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': os.environ.get('POSTGRES_DB', 'instahub'),
...
SPECTACULAR_SETTINGS = {
    'TITLE': 'InstaHub API',
    'DESCRIPTION': 'Возможности и настройки приложения',
    'VERSION': '1.0.0',
    'SERVE_INCLUDE_SCHEMA': False,
    'CONTACT': {'url': 'Тут будет ссылка'},
    "SWAGGER_UI_SETTINGS": {
